...
function getPayoff(bars, position, pid) {
    ...
    payoff = node.game.incomes[pid]-group[position[1]][0] + payoff; //before: payoff = INITIAL_COINS-group[position[1]][0] + payoff;
    return payoff;
}
...
// Non Merit-based and high mobility
treatments.Treatment_3 = {
